...
class AutoTrajectoryKotlin : LinearOpMode() {
    override fun runOpMode() {
        ...
        val blueRight = drive.actionBuilder(drive.pose)
            ...
            .splineToLinearHeading(Pose2d(-60.0, -48.0, Math.toRadians(-90.0)), Math.toRadians(-90.0))
            ...
            .splineToConstantHeading(Vector2d(-60.0, 48.0), Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(-60.0, 60.0), Math.toRadians(90.0))
            .build()

        val blueLeft = drive.actionBuilder(drive.pose)
            .setTangent(Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(-54.0, 24.0), Math.toRadians(45.0))
            .splineToLinearHeading(Pose2d(-54.0, 18.0, Math.toRadians(0.0)), Math.toRadians(-90.0))
            .splineToConstantHeading(Vector2d(-45.0, 12.0,), Math.toRadians(90.0))
            .splineToLinearHeading(Pose2d(-54.0, 36.0, Math.toRadians(-90.0)), Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(-36.0, 36.0), Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(-60.0, 48.0), Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(-60.0, 60.0), Math.toRadians(90.0))
            .build()
        ...
        val redRight = drive.actionBuilder(drive.pose)
            .setTangent(Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(54.0, 24.0), Math.toRadians(135.0))
            .splineToLinearHeading(Pose2d(54.0, 18.0, Math.toRadians(180.0)), Math.toRadians(-90.0))
            .splineToConstantHeading(Vector2d(45.0, 12.0,), Math.toRadians(90.0))
            .splineToLinearHeading(Pose2d(54.0, 36.0, Math.toRadians(-90.0)), Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(36.0, 36.0), Math.toRadians(90.0))
            .splineToConstantHeading(Vector2d(60.0, 48.0), Math.toRadians(90.0))
